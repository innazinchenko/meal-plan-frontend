...
const getAllMeals = (setMeal) => {
    axios.get("https://meal-plan-946c.onrender.com")
...
const addMeal = (title, setTitle, setMeal) => {
    axios.post('https://meal-plan-946c.onrender.com/saveMeals', { title })
    .then((data) => {
        console.log(data)
        setTitle("")
        getAllMeals(setMeal)
...
const deleteMeal = (_id, setMeal) => {
    axios.post('https://meal-plan-946c.onrender.com/deleteMeal', { _id })
    .then((data) => {
        console.log(data)
        getAllMeals(setMeal)
    })
